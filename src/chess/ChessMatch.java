...
public class ChessMatch {
	...
	// faz o movimento e captura peça
	...
	public ChessPiece replacePromotedPiece(String type) {
		...
		if (!type.toUpperCase().equals("B") && !type.toUpperCase().equals("N") && !type.toUpperCase().equals("Q") && !type.toUpperCase().equals("R")) {
